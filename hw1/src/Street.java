...
public class Street {
    ...
    private MyList<House> houses1;
    private MyList<House> houses2;
    private MyList<Office> offices1;
    private MyList<Office> offices2;
    private MyList<Market> markets1;
    private MyList<Market> markets2;
    private MyList<Playground> playgrounds1;
    private MyList<Playground> playgrounds2;
/**
 ...
 */
    public Street(int length){
        ...
        this.houses1 = new MyList<>();
        this.houses2 = new MyList<>();
        this.offices1 = new MyList<>();
        this.offices2 = new MyList<>();
        this.markets1 = new MyList<>();
        this.markets2 = new MyList<>();
        this.playgrounds1 = new MyList<>();
        this.playgrounds2 = new MyList<>();
