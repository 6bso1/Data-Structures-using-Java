...
public class Street {
    ...
    private LinkedList<House> houses1;
    private LinkedList<House> houses2;
    private LinkedList<Office> offices1;
    private LinkedList<Office> offices2;
    private LinkedList<Market> markets1;
    private LinkedList<Market> markets2;
    private LinkedList<Playground> playgrounds1;
    private LinkedList<Playground> playgrounds2;
/**
 ...
 */
    public Street(int length){
        ...
        this.houses1 = new LinkedList<>();
        this.houses2 = new LinkedList<>();
        this.offices1 = new LinkedList<>();
        this.offices2 = new LinkedList<>();
        this.markets1 = new LinkedList<>();
        this.markets2 = new LinkedList<>();
        this.playgrounds1 = new LinkedList<>();
        this.playgrounds2 = new LinkedList<>();
