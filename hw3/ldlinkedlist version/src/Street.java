...
public class Street {
    ...
    private LDLinkedList<House> houses1;
    private LDLinkedList<House> houses2;
    private LDLinkedList<Office> offices1;
    private LDLinkedList<Office> offices2;
    private LDLinkedList<Market> markets1;
    private LDLinkedList<Market> markets2;
    private LDLinkedList<Playground> playgrounds1;
    private LDLinkedList<Playground> playgrounds2;
/**
 ...
 */
    public Street(int length){
        ...
        this.houses1 = new LDLinkedList<>();
        this.houses2 = new LDLinkedList<>();
        this.offices1 = new LDLinkedList<>();
        this.offices2 = new LDLinkedList<>();
        this.markets1 = new LDLinkedList<>();
        this.markets2 = new LDLinkedList<>();
        this.playgrounds1 = new LDLinkedList<>();
        this.playgrounds2 = new LDLinkedList<>();
